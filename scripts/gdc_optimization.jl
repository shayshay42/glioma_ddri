...
population = deserialize(prefix*"/assets/$(drug)_vp5.jls")
tumor_min_scaling = deserialize(prefix*"/assets/$(drug)_max_dose_min_tumor_v5.jls")
tumor_max_scaling = deserialize(prefix*"/assets/$(drug)_min_dose_max_tumor_v5.jls")
...
drug_min_scaling = 40.0*length(gdc_dosetimes)#min_drug_dosage
drug_max_scaling = 600.0*length(gdc_dosetimes)#sum(doses)
