...
# Define the equations
eq1 = Eq(x.diff(t), -a*x)
eq2 = Eq(y.diff(t), a*x - b*y - c*y + d*z)
eq3 = Eq(z.diff(t), c*y - d*z)
...
(Eq(x(t), x0*exp(-ka*t)), 
 Eq(Integral((b*y(t) + c*y(t) - d*z(t) - ka*x(t))*exp(b*t)*exp(c*t), t), b*Integral(y(t)*exp(b*t)*exp(c*t), (t, 0)) + c*Integral(y(t)*exp(b*t)*exp(c*t), (t, 0)) - d*Integral(z(t)*exp(b*t)*exp(c*t), (t, 0)) - ka*Integral(x(t)*exp(b*t)*exp(c*t), (t, 0))), 
 Eq(-c*Integral(y(t)*exp(d*t), t) + d*Integral(z(t)*exp(d*t), t), -c*Integral(y(t)*exp(d*t), (t, 0)) + d*Integral(z(t)*exp(d*t), (t, 0))))
